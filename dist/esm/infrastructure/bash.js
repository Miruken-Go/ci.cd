...
export function execute(cmd_1) {
    return __awaiter(this, arguments, void 0, function (cmd, suppressLog) {
        var _a, stdout, stderr;
        if (suppressLog === void 0) { suppressLog = false; }
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4, exec(cmd)];
                case 1:
...
export function json(cmd_1) {
    return __awaiter(this, arguments, void 0, function (cmd, suppressLog) {
        var response;
        if (suppressLog === void 0) { suppressLog = false; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, execute(cmd, suppressLog)];
                case 1:
                    response = _a.sent();
