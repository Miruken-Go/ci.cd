            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, axios.post(uri, querystring.stringify({
        ...
        return __awaiter(this, arguments, void 0, function (endpoint, version) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        _d.trys.push([2, 4, , 5]);
                        return [4, axios.get(uri, options)];
        ...
        return __awaiter(this, arguments, void 0, function (endpoint, json, version) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        _d.trys.push([2, 4, , 5]);
                        return [4, axios.post(uri, json, options)];
                    case 3: return [2, _d.sent()];
                    case 4:
                        error_2 = _d.sent();
        ...
        return __awaiter(this, arguments, void 0, function (endpoint, json, version) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        _d.trys.push([2, 4, , 5]);
                        return [4, axios.patch(uri, json, options)];
                    case 3: return [2, _d.sent()];
                    case 4:
                        error_3 = _d.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        _d.trys.push([2, 4, , 5]);
                        return [4, axios.put(uri, xml, options)];
                    case 3:
                        result = _d.sent();
